...
/**
 * This is a builder to class to create a multi subscription with multiple
 * components. An instance of this class may be acquired via the method
 * {@link PepBuilderService#getMultiBuilder()
 * PepBuilderService.getMultiBuilder()}.
 * <p>
 * A subscription subject can be set with the function {@link #subject(Object)}.
 * The "with()" method is an overloaded function which allows to add a Vaadin
 * component to the subscription. Calling the "with()" function will return a
 * specific multi-pep-builder object (In case of a button for example
 * {@link VaadinPep.VaadinMultiButtonPepBuilder}). This multi-pep-builder can be
 * used to set action and resource of the subscription. To add another
 * component, the function "and()" of the multi-pep-builder may be used. When
 * the configuring is done, call "build()" to start the multi subscription.
...
public class MultiBuilder {
    ...
    /**
     * This function shall create a {@link VaadinPep.VaadinMultiComponentPepBuilder}
    ...
    public VaadinPep.VaadinMultiComponentPepBuilder with(Component component) {
        return new VaadinPep.VaadinMultiComponentPepBuilder(pdp, vaadinConstraintEnforcementService, this, component);
    }

    /**
     * This function shall create a {@link VaadinPep.VaadinMultiButtonPepBuilder}
    ...
    public VaadinPep.VaadinMultiButtonPepBuilder with(Button button) {
        return new VaadinPep.VaadinMultiButtonPepBuilder(pdp, vaadinConstraintEnforcementService, this, button);
    }

    /**
     * This function shall create a {@link VaadinPep.VaadinMultiTextFieldPepBuilder}
     * with the given text field.
     *
    ...
    public VaadinPep.VaadinMultiTextFieldPepBuilder with(TextField textField) {
        return new VaadinPep.VaadinMultiTextFieldPepBuilder(pdp, vaadinConstraintEnforcementService, this, textField);
    }

    /**
     * This function shall create a {@link VaadinPep.VaadinMultiCheckboxPepBuilder}
     * with the given checkbox.
     *
    ...
    public VaadinPep.VaadinMultiCheckboxPepBuilder with(Checkbox checkbox) {
        return new VaadinPep.VaadinMultiCheckboxPepBuilder(pdp, vaadinConstraintEnforcementService, this, checkbox);
    }

    /**
     * This function shall create a {@link VaadinPep.VaadinMultiSpanPepBuilder} with
     * the given span.
     *
    ...
    public VaadinPep.VaadinMultiSpanPepBuilder with(Span span) {
        return new VaadinPep.VaadinMultiSpanPepBuilder(pdp, vaadinConstraintEnforcementService, this, span);
    }
     ...
     * Note: This function cancels the current subscription and restarts it after
    ...
    /**
     * This function shall get all authorization subscriptions from the container
    ...
    /**
     * This function shall execute the build and start the multi subscription. An
     * AccessDeniedException shall be thrown, if build has already been called.
     *
