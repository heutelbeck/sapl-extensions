...
/**
 * This Constraint Handler Provider can be used to show a (custom) confirmation
 * dialog based on SAPL Obligations. This provider manages constrains of type
 * "saplVaadin" with id "requestConfirmation", here an example: ... obligation {
 * "type": "saplVaadin", "id" : "requestConfirmation", "header": "Confirm
 * Dialog", "text": "Please accept the policies.", "confirmText": "Okay",
 * "cancelText": "No" } ...
 *
 */
@Service
...
public class VaadinConfirmationDialogConstraintHandlerProvider implements VaadinFunctionConstraintHandlerProvider {
    ...
    void openConfirmDialog(String header, String text, String confirmText, Runnable confirmAction, String cancelText,
            Runnable cancelAction) {
        new VaadinConfirmationDialog(header, text, confirmText, confirmAction, cancelText, cancelAction).open();
    }
}
