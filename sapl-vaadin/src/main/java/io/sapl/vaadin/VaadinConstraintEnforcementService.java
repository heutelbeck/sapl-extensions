...
/**
 * This class provides functions for constraint handling. The function
 * {@link VaadinConstraintEnforcementService#enforceConstraintsOfDecision(AuthorizationDecision, UI, VaadinPep)}
...
public class VaadinConstraintEnforcementService implements EnforceConstraintsOfDecision {
    ...
    /**
     * This function adds a VaadinFunctionConstraintHandlerProvider to the list of
     * global ConstraintHandlerProviders.
     *
    ...
    /**
     * This function adds a UI ConsumerConstraintHandlerProvider to the list of
     * global ConstraintHandlerProviders.
     *
     * @param provider ConstraintHandlerProvider to be added
     */
    ...
    /**
     * This function adds a RunnableConstraintHandlerProvider to the list of global
    ...
    /**
     * This function gets all constraint handlers, executes them and returns the
     * derived decision. In the following cases a DENY is returned: - No handlers
     * have been executed - Runnable throws a non-fatal exception and obligations
     * are present
     *
     ...
     */
    @Override
    public Mono<AuthorizationDecision> enforceConstraintsOfDecision(AuthorizationDecision authorizationDecision, UI ui,
            VaadinPep vaadinPep) {
        try {
    ...
    /**
     * This function creates a new {@link VaadinConstraintHandlerBundle}, fills and
     * returns it.
     *
    ...
    /**
     * This function creates and returns a wrapped vaadin function to handle throw
     * ables. The wrapped function behaves as follows: - Original function is
     * executed - If a fatal throwable is caught, it is rethrown. - If a non-fatal
     * throwable is caught and isObligation is set, an {@link AccessDeniedException}
     * is thrown. - If a non-fatal throwable is caught and isObligation is not set,
     ...
     * The wrapped function behaves as follows: - Consumer is executed - If a fatal
     * throwable is caught, it is rethrown. - If a non-fatal throwable is caught and
     ...
     * The wrapped function behaves as follows: - Runnable is executed - If a fatal
     * throwable is caught, it is rethrown. - If a non-fatal throwable is caught and
     * isObligation is set, an {@link AccessDeniedException} is thrown.
     *
     * @param isObligation Set to true, if executed in context of an obligation,
