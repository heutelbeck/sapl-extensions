...
/**
 * This utility class provides functions to evaluate the format and to convert the payload of a mqtt message
...
public class PayloadFormatUtility {
    ...
    /**
     * Looks up the payload format indicator from the mqtt publish message. By default, it will be 0.
    ...
    public static int getPayloadFormatIndicator(Mqtt5Publish publishMessage) {
        ...
        Optional<Mqtt5PayloadFormatIndicator> payloadFormatIndicatorOptional =
                publishMessage.getPayloadFormatIndicator();
     ...
     * @param publishMessage the published mqtt message
     * @return returns the content type or null in case no content type was specified
     */
    public static String getContentType(Mqtt5Publish publishMessage) {
        Optional<MqttUtf8String> contentTypeOptional = publishMessage.getContentType(); // specifies kind of utf-8 encoded payload
     ...
     * @return returns true if a conversions into a UTF-8 string is possible, otherwise false
     */
     ...
     * @param publishMessage the published mqtt message
     * @return returns the build {@link Val} of the json object or a {@link Val} of error in case the mqtt message
     * could not be converted into a json object.
     */
    ...
    /**
     * Converts the given array of bytes to a json array node containing the bytes as integers.
