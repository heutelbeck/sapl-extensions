...
public class DefaultResponseUtility {
     ...
     */
    public static final String ENVIRONMENT_DEFAULT_RESPONSE_TIMEOUT = "timeoutDuration"; // initial value will be published after timeout
    ...
    public static Val getDefaultVal(DefaultResponseConfig defaultResponseConfig) {
        ...
        if (!(DEFAULT_RESPONSE_TYPE.equals(defaultResponseType) || "error".equals(defaultResponseType))) {
            log.warn("The specified default response type '{}' is illegal. The default configuration will" +
