...
public class SubscriptionUtility {
    ...
    /**
     * Adds the count of the topics contained in the subscription to the count of the topic subscription list.
     * @param clientValues the object containing the topic subscription list
     * @param mqtt5SubAck the acknowledgement message specifying whether a subscription of a topic was
     *                    successfully established or not
     * @param topicSubscription the topic subscription containing the topics which count is to add
     */
