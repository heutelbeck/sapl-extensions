...
public final class MqttClientValues {
     ...
     * @param mqttBrokerConfig the configuration of the connection to the mqtt broker
    ...
    /**
     * Adds 1 to the existing count. If there was no entry for the referenced count before, then a new entry
     * will be set to the count of 1.
    ...
    /**
     * Reduces the count by one. If the new count would be 0 than the topic reference will be deleted.
     * @param topic the reference for the topic count
     * @return returns true in case there is a new positive count for the topic otherwise returns false
     */
