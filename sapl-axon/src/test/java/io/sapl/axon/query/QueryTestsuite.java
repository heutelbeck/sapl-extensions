...
import static io.sapl.axon.query.TestUtilities.isCausedBy;
...
import io.sapl.axon.query.QueryTestsuite.TestScenarioConfiguration;
...
public abstract class QueryTestsuite {
	private static final String CONSUME_UPDATE                   = "consume update";
	...
	@SpyBean
	ResultMessageConsumerProvider resultMessageConsumerProvider;
	...
	static class ResultMessageConsumerProvider implements ResultMessageConsumerConstraintHandlerProvider<String> {

		@Override
		public boolean isResponsible(JsonNode constraint) {
			return constraint.isTextual() && CONSUME_UPDATE.equals(constraint.textValue());
		}
		...
		@Override
		public Consumer<ResultMessage<?>> getHandler(JsonNode constraint) {
			return this::accept;
		}

		public void accept(ResultMessage<?> result) {
			// NOOP
		}
	}
	...
	static class TestScenarioConfiguration {
		...
		@Bean
		ResultMessageConsumerProvider resultMessageConsumerProvider() {
			return new ResultMessageConsumerProvider();
		}
