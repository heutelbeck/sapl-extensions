...
class EnforceRecoverableIfDeniedPolicyEnforcementPointTests {
    ...
    void when_pep_empty_then_noEvent() {
        ...
        var enforcedUpdateMessageFlux = of(query, decisions, resourceAccessPoint, defaultConstraintHandlerService,
    ...
    void when_pep_multiplePermit_and_multipleUpdate_and_ressource_then_permitThenDropThePermit() {
        ...
        var decisions          = Flux.concat(
                ...
                Mono.delay(DEFAULT_TIMESTEP.multipliedBy(4))
                        .thenReturn(new AuthorizationDecision(Decision.PERMIT, Value.EMPTY_ARRAY, Value.EMPTY_ARRAY,
                                defaultResource)),
                Mono.delay(DEFAULT_TIMESTEP.multipliedBy(8)).thenReturn(AuthorizationDecision.PERMIT));
