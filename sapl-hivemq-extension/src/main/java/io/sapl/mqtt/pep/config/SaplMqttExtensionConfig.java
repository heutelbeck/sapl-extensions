...
public class SaplMqttExtensionConfig {
    ...
    private static final String ENVIRONMENT_CONNECTION_ENFORCEMENT_TIMEOUT_MILLIS =
            "connection-enforcement-timeout-millis";
    private static final String ENVIRONMENT_SUBSCRIPTION_ENFORCEMENT_TIMEOUT_MILLIS =
            "subscription-enforcement-timeout-millis";
    private static final String ENVIRONMENT_PUBLISH_ENFORCEMENT_TIMEOUT_MILLIS =
            "publish-enforcement-timeout-millis";
    private static final String ENVIRONMENT_AUTHZ_SUBSCRIPTION_TIMEOUT_MILLIS =
            "authz-subscription-timeout-millis";
    /**
     * References the pdp implementation type in the sapl mqtt extension configuration file.
     */
    ...
    private static final String ENVIRONMENT_IS_EMBEDDED_PDP_POLICIES_PATH_RELATIVE_TO_EXTENSION_HOME =
            "embedded-pdp-policies-path-is-relative-to-extension-home";
    /**
     * References the url of a remote PDP in the sapl mqtt extension configuration file.
     */
    public static final String ENVIRONMENT_REMOTE_PDP_BASE_URL = "remote-pdp-base-url";
    /**
     * References the client key in the sapl mqtt extension configuration file for communications with the remote PDP.
     */
    public static final String ENVIRONMENT_REMOTE_PDP_CLIENT_KEY = "remote-pdp-client-key";
    /**
     * References the client secret in the sapl mqtt extension configuration file for communications with the remote PDP.
     */
    ...
    static final String DEFAULT_PDP_IMPLEMENTATION = "embedded"; // alternatively "remote"
     ...
     */
    public static final String DEFAULT_REMOTE_PDP_CLIENT_SECRET =
            "$2a$10$Ph9bF71xYb0MK8KubWLB7e0Dpl2AfMiEUi9jrKTbFR4kkWABRb9yO";
    ...
    /**
     * This method is a copy constructor to replicate another {@link SaplExtensionConfiguration}.
    ...
    public SaplMqttExtensionConfig(SaplMqttExtensionConfig saplMqttExtensionConfig) {
        ...
        this.isEmbeddedPdpPoliciesPathRelativeToExtensionHome =
                saplMqttExtensionConfig.isEmbeddedPdpPoliciesPathRelativeToExtensionHome;
    ...
    @XmlElement(name = ENVIRONMENT_CONNECTION_ENFORCEMENT_TIMEOUT_MILLIS,
            defaultValue = ""+DEFAULT_CONNECTION_ENFORCEMENT_TIMEOUT_MILLIS)
    private int connectionEnforcementTimeoutMillis = DEFAULT_CONNECTION_ENFORCEMENT_TIMEOUT_MILLIS;

    @XmlElement(name = ENVIRONMENT_SUBSCRIPTION_ENFORCEMENT_TIMEOUT_MILLIS,
            defaultValue = ""+DEFAULT_SUBSCRIPTION_ENFORCEMENT_TIMEOUT_MILLIS)
    private int subscriptionEnforcementTimeoutMillis = DEFAULT_SUBSCRIPTION_ENFORCEMENT_TIMEOUT_MILLIS;

    @XmlElement(name = ENVIRONMENT_PUBLISH_ENFORCEMENT_TIMEOUT_MILLIS,
            defaultValue = ""+DEFAULT_PUBLISH_ENFORCEMENT_TIMEOUT_MILLIS)
    private int publishEnforcementTimeoutMillis = DEFAULT_PUBLISH_ENFORCEMENT_TIMEOUT_MILLIS;

    @XmlElement(name = ENVIRONMENT_AUTHZ_SUBSCRIPTION_TIMEOUT_MILLIS,
            defaultValue = ""+DEFAULT_AUTHZ_SUBSCRIPTION_TIMEOUT_MILLIS)
    private int authzSubscriptionTimeoutMillis = DEFAULT_AUTHZ_SUBSCRIPTION_TIMEOUT_MILLIS;

    @XmlElement(name = ENVIRONMENT_PDP_IMPLEMENTATION,
            defaultValue = DEFAULT_PDP_IMPLEMENTATION)
    private String pdpImplementation = DEFAULT_PDP_IMPLEMENTATION;

    @XmlElement(name = ENVIRONMENT_EMBEDDED_PDP_POLICIES_PATH,
            defaultValue = DEFAULT_EMBEDDED_PDP_POLICIES_PATH)
    private String embeddedPdpPoliciesPath = DEFAULT_EMBEDDED_PDP_POLICIES_PATH;

    @XmlElement(name = ENVIRONMENT_IS_EMBEDDED_PDP_POLICIES_PATH_RELATIVE_TO_EXTENSION_HOME,
            defaultValue = ""+ DEFAULT_IS_EMBEDDED_PDP_POLICIES_PATH_RELATIVE_TO_EXTENSION_HOME)
    private boolean isEmbeddedPdpPoliciesPathRelativeToExtensionHome =
            DEFAULT_IS_EMBEDDED_PDP_POLICIES_PATH_RELATIVE_TO_EXTENSION_HOME;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_FIRST_BACK_OFF_MILLIS,
            defaultValue = ""+DEFAULT_REMOTE_PDP_FIRST_BACK_OFF_MILLIS)
    private int remotePdpFirstBackOffMillis = DEFAULT_REMOTE_PDP_FIRST_BACK_OFF_MILLIS;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_MAX_BACK_OFF_MILLIS,
            defaultValue = ""+DEFAULT_REMOTE_PDP_MAX_BACK_OFF_MILLIS)
    private int remotePdpMaxBackOffMillis = DEFAULT_REMOTE_PDP_MAX_BACK_OFF_MILLIS;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_BACK_OFF_FACTOR,
            defaultValue = ""+DEFAULT_REMOTE_PDP_BACK_OFF_FACTOR)
    private int remotePdpBackOffFactor = DEFAULT_REMOTE_PDP_BACK_OFF_FACTOR;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_BASE_URL,
            defaultValue = DEFAULT_REMOTE_PDP_BASE_URL)
    private String remotePdpBaseUrl = DEFAULT_REMOTE_PDP_BASE_URL;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_CLIENT_KEY,
            defaultValue = DEFAULT_REMOTE_PDP_CLIENT_KEY)
    private String remotePdpClientKey = DEFAULT_REMOTE_PDP_CLIENT_KEY;

    @XmlElement(name = ENVIRONMENT_REMOTE_PDP_CLIENT_SECRET,
            defaultValue = DEFAULT_REMOTE_PDP_CLIENT_SECRET)
