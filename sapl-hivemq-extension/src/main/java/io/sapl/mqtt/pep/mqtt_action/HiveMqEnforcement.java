...
public class HiveMqEnforcement {
     ...
     *         case the mqtt connection isn't granted or the asynchronous processing
     *         timed out before granting, false will be returned.
     * @param authnOutput                       used to grand or refuse the mqtt
     *                                          connection
     * @param authzDecision                     the decision of whether the access
     *                                          shall be granted or not
     * @param hasHandledObligationsSuccessfully whether all obligations are handled
     *                                          successfully or not
     * @param mqttSaplId                        provides unique specifications used
     *                                          to identify the decision flux
     */
