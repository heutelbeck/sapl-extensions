...
public final class MqttClientState {
    ...
    private Disposable.Composite sharedClientDecisionFluxDisposable = Disposables.composite();
    ...
    private Disposable.Composite mqttActionDecisionFluxesDisposablesComposite = Disposables.composite();
    ...
    /**
     * Adds the {@link IdentifiableAuthorizationDecision} to the cache under the given reference. Any existing
     * value under the reference will be hereby overridden.
     * @param id the reference for the {@link IdentifiableAuthorizationDecision}
     * @param identAuthzDecision the {@link IdentifiableAuthorizationDecision} to add
     */
    ...
    /**
     * Removes the referenced {@link IdentifiableAuthorizationDecision} from the {@link Map}.
    ...
    /**
     * Removes the referenced list of unsubscribe message topics from the {@link Map}.
    ...
    /**
     * Checks whether the list of unsubscribe message topics {@link Map} is empty or not.
     ...
     * @param id the reference of the mqtt action decision flux {@link Disposable} to remove
     * @return the removed mqtt action decision flux {@link Disposable} or null in case there was no mapping
     */
     ...
     * @param id the reference of the mqtt action decision flux {@link Disposable} to return
    ...
    /**
     * Adds the given mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} to the state.
     * @param id the reference under which the mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>}
     *           s to add
     * @param identAuthzFlux the mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} to add
     */
    ...
    /**
     * Gets the referenced mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} from the state.
     * @param id the reference of the mqtt action decision flux to return
     * @return the referenced mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>}
     */
    ...
    /**
     * Removes the referenced mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} from the state.
     * @param id the reference of the mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} to remove
     */
    ...
    /**
     * Gets all mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} from the state.
     * @return all mqtt action decision {@link Flux<IdentifiableAuthorizationDecision>} from the state
     */
    ...
    public MultiAuthorizationSubscription getMultiAuthzSubscription() {
        ...
        multiAuthzSubscriptionCopy.setAuthorizationSubscriptions(
                multiAuthzSubscription.getAuthorizationSubscriptions());
    ...
    /**
     * Adds the given {@link AuthorizationSubscription} to the {@link MultiAuthorizationSubscription}.
     * @param id the reference under which the {@link AuthorizationSubscription} is to add
    ...
    /**
     * Removes the referenced {@link AuthorizationSubscription} from the {@link MultiAuthorizationSubscription}
     * of the state.
    ...
    public void removeSaplAuthzSubscriptionFromMultiSubscription(String id) {
        Map<String, AuthorizationSubscriptionElements> authzSubscriptionElementsMap =
                multiAuthzSubscription.getAuthorizationSubscriptions();
    ...
    /**
     * Gets the {@link AuthorizationSubscription} from the {@link MultiAuthorizationSubscription} of the state.
     * @param id the reference of the {@link AuthorizationSubscription} to return
     * @return the referenced {@link AuthorizationSubscription} of the {@link MultiAuthorizationSubscription}
     */
    ...
    /**
     * Adds the given {@link Disposable} to the shared client decision flux {@link Disposable.Composite}.
     * @param disposable the {@link Disposable} to add
     */
    ...
    /**
     * Disposes the shared client decision flux and sets a new {@link Disposable.Composite}.
     */
    ...
    /**
     * Adds the given {@link Disposable} of the mqtt action decision flux to the {@link Disposable.Composite}.
     * @param disposable the {@link Disposable} to add
     ...
     * @return true if the {@link Disposable.Composite} was disposed, false otherwise
     */
    ...
    /**
     * Disposes the mqtt action decision fluxes and sets a new {@link Disposable.Composite}.
     */
    ...
    /**
     * Removes the given {@link Disposable} from the mqtt action decision flux {@link Disposable.Composite}.
