...
class WildcardSubscriptionEnforcementTest extends SaplMqttPepTest {
    ...
    void when_subscribedWithMultiLevelWildcardAndAnotherTopicSubscriptionDenied_then_getMessagesOverWildcard() {
        ...
        Mqtt5Subscription secondSubscription = Mqtt5Subscription.builder().topicFilter("first/second").build();
    ...
    void when_subscribedWithSingleLevelWildcardAndAnotherTopicSubscriptionDenied_then_getMessagesOverWildcard() {
        // GIVEN
        Mqtt5Subscription firstSubscription = Mqtt5Subscription.builder().topicFilter("first/+/third").build();
        Mqtt5Subscription secondSubscription = Mqtt5Subscription.builder().topicFilter("first/second/third").build();
        Mqtt5Subscribe subscribeMessageMultipleTopics = Mqtt5Subscribe.builder()
                .addSubscriptions(firstSubscription, secondSubscription)
                .build();
